...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.login) {
            ...
            startActivity(i);
        } else if (id == R.id.view_plants) {
            Intent i=new Intent(MainActivity.this,ViewPlants.class);
            startActivity(i);
            ...
            Intent i=new Intent(MainActivity.this,Accessories.class);
            startActivity(i);
        ...
        if(id==R.id.share)
        {
            ...
            i.putExtra(Intent.EXTRA_SUBJECT,"Please download my app");
